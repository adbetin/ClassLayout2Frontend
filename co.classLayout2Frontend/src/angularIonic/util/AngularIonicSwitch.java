 ...
 * @generated
 */
public class AngularIonicSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AngularIonicPackage.APPLICATION: {
				Application application = (Application)theEObject;
				T result = caseApplication(application);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AngularIonicPackage.PAGE: {
				Page page = (Page)theEObject;
				T result = casePage(page);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AngularIonicPackage.COMPONENT: {
				Component component = (Component)theEObject;
				T result = caseComponent(component);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AngularIonicPackage.ITERATION_COMPONENT: {
				IterationComponent iterationComponent = (IterationComponent)theEObject;
				T result = caseIterationComponent(iterationComponent);
				if (result == null) result = caseComponent(iterationComponent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AngularIonicPackage.INPUT: {
				Input input = (Input)theEObject;
				T result = caseInput(input);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AngularIonicPackage.OUTPUT: {
				Output output = (Output)theEObject;
				T result = caseOutput(output);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AngularIonicPackage.CLASS: {
				angularIonic.Class class_ = (angularIonic.Class)theEObject;
				T result = caseClass(class_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AngularIonicPackage.PROPERTY: {
				Property property = (Property)theEObject;
				T result = caseProperty(property);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AngularIonicPackage.STATIC_COMPONENT: {
			...
			case AngularIonicPackage.FORM_COMPONENT: {
				FormComponent formComponent = (FormComponent)theEObject;
				T result = caseFormComponent(formComponent);
				if (result == null) result = caseComponent(formComponent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AngularIonicPackage.FILTER: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Iteration Component</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Iteration Component</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseIterationComponent(IterationComponent object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseClass(angularIonic.Class object) {
		return null;
	}
