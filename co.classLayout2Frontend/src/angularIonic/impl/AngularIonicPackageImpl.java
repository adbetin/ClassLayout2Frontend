 ...
 * @generated
 */
public class AngularIonicPackageImpl extends EPackageImpl implements AngularIonicPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	private EClass iterationComponentEClass = null;
	 ...
	 * @see angularIonic.AngularIonicPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private AngularIonicPackageImpl() {
		super(eNS_URI, AngularIonicFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link AngularIonicPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static AngularIonicPackage init() {
		if (isInited) return (AngularIonicPackage)EPackage.Registry.INSTANCE.getEPackage(AngularIonicPackage.eNS_URI);

		// Obtain or create and register package
		AngularIonicPackageImpl theAngularIonicPackage = (AngularIonicPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof AngularIonicPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new AngularIonicPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theAngularIonicPackage.createPackageContents();

		// Initialize created meta-data
		theAngularIonicPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theAngularIonicPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(AngularIonicPackage.eNS_URI, theAngularIonicPackage);
		return theAngularIonicPackage;
	}
	 ...
	 * @generated
	 */
	public EReference getPage_InstanceComponent() {
	 ...
	 * @generated
	 */
	public EClass getIterationComponent() {
		return iterationComponentEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getIterationComponent_Filter() {
		return (EReference)iterationComponentEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getFilter_Property() {
	 ...
	 * @generated
	 */
	public AngularIonicFactory getAngularIonicFactory() {
		return (AngularIonicFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(applicationEClass, APPLICATION__DISPLAY_NAME);

		pageEClass = createEClass(PAGE);
		createEAttribute(pageEClass, PAGE__NAME);
		createEAttribute(pageEClass, PAGE__DISPLAY_NAME);
		createEReference(pageEClass, PAGE__INSTANCE_COMPONENT);
		...
		iterationComponentEClass = createEClass(ITERATION_COMPONENT);
		createEReference(iterationComponentEClass, ITERATION_COMPONENT__FILTER);
		...
		createEReference(filterEClass, FILTER__PROPERTY);
	...
	public void initializePackageContents() {
		...
		iterationComponentEClass.getESuperTypes().add(this.getComponent());
		staticComponentEClass.getESuperTypes().add(this.getComponent());
		formComponentEClass.getESuperTypes().add(this.getComponent());
		...
		initEReference(getApplication_Components(), this.getComponent(), null, "components", null, 1, -1, Application.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getApplication_DisplayName(), ecorePackage.getEString(), "displayName", null, 0, 1, Application.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getPage_DisplayName(), ecorePackage.getEString(), "displayName", null, 0, 1, Page.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPage_InstanceComponent(), this.getComponent(), null, "instanceComponent", null, 1, -1, Page.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(iterationComponentEClass, IterationComponent.class, "IterationComponent", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getIterationComponent_Filter(), this.getFilter(), null, "filter", null, 0, -1, IterationComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getInput_DataType(), this.getDataType(), "dataType", null, 0, 1, Input.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getOutput_DataType(), this.getDataType(), "dataType", null, 0, 1, Output.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(classEClass, angularIonic.Class.class, "Class", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getClass_Name(), ecorePackage.getEString(), "name", null, 0, 1, angularIonic.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getClass_Properties(), this.getProperty(), null, "properties", null, 1, -1, angularIonic.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getFilter_Property(), this.getProperty(), null, "property", null, 1, 1, Filter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(dataTypeEEnum, DataType.ANY);

		// Create resource
		createResource(eNS_URI);
	}

} //AngularIonicPackageImpl
